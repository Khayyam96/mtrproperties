...
const reviews = [
    {
        ...
        date: "Feb 19, 2025",
        rating: 1,
        comment: "Waiting for 20 minutes no service",
        avatarColor: "#6fcf97",
    },
    {
        name: "Gautam Kohli",
    ...
    },
    {
        ...
        date: "Dec 26, 2024",
        rating: 2,
        comment: "The bakery items(pastries) were a huge disappointment - stale, dry and clearly not fresh.",
        avatarColor: "#2d9cdb",
    },
    {
        name: "Rafik Khan",
                        ...
                        <div key={idx}>
                            <div className="review-card">
                                <div className="review-header">
                                    <Avatar style={{ backgroundColor: review.avatarColor }}>
                                        {review.name[0]}
                                    </Avatar>
