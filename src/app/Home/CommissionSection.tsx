...
const features = [
  { icon: "/icc1.png", title: "90-100% Commission", desc: "Keep what you earn with our revolutionary commission structure" },
  { icon: "/icc2.png", title: "Full Support System", desc: "Complete back-office support and transaction coordination" },
  { icon: "/icc3.png", title: "Unlimited Growth", desc: "No caps or limits on your earning potential" },
    ...
    <div className="commission-section">
      <Container>
        ...
        <Row gutter={[40, 40]} className="commission-main-row">
          <Col xs={24} lg={16}>
            <Title level={4} className="features-title">Why Choose Our Broker Program?</Title>

            <Row gutter={[24, 24]}>
              {features.map((item, idx) => (
                <Col xs={24} sm={12} key={idx}>
                  {/* CHANGED: variant="borderless" */}
                  <Card variant="borderless" className="feature-card">
                    <div className="feature-card-inner">
                      <Image src={item.icon} alt={item.title} width={40} height={40} className="feature-icon" />
                      <div>
          ...
          <Col xs={24} lg={8}>
            {/* CHANGED: variant="borderless" */}
            <Card className="calculator-card" variant="borderless">
              <div className="tags">
