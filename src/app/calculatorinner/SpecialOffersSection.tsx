...
const defaultRows: OfferRow[] = [
  {
    key: "zero-commission",
    name: "Zero Commission Deal",
    benefit: "No agent commission on select new launches",
...
const SpecialOffersSection: FC<Props> = ({
  ...
  const SideCard = (
    <Card className={styles.sideCard} bordered>
      ...
      <Paragraph className={styles.sideBody}>{sideBody}</Paragraph>
    </Card>
  );

  return (
    <section className={`${styles.wrapspecial} ${className || ""}`}>
